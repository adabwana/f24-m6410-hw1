...
(let [mu 28600 sd 2700 x 20000
      ...
      p prob]
  (answer
    (str "Probability that a career service employee chosen at random has an annual benefit cost less than $20,000: " (* 100 (m/approx p)) "%")))
...
(let [mu 28600 sd 2700 x 27000
      ...
      p (- 1 prob)]
  (answer
    (str "Probability that a career service employee chosen at random has an annual benefit cost more than $27,000: " (* 100 (m/approx p)) "%")))
